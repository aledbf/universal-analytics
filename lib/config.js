...
module.exports = {
	...
	path: "/collect",
	acceptedParameters: ["p","v","tid","aip","qt","z","cid","uid","sc","uip","ua","dr","cn","cs","cm","ck","cc","ci","gclid","dclid","sr","vp","de","sd","ul","je","fl","t","ni","dl","dh","dp","dt","cd","linkid","an","aid","av","aiid","ec","ea","el","ev","ti","ta","tr","ts","tt","in","ip","iq","ic","iv","cu","sn","sa","st","utc","utv","utt","utl","plt","dns","pdt","rrt","tcp","srt","exd","exf","xid","xvar"],
